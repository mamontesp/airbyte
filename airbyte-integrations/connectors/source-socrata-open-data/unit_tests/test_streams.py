...
import pytest
from source_datos_gov_co.source import DatosGovCoStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DatosGovCoStream, "path", "v0/example_endpoint")
    mocker.patch.object(DatosGovCoStream, "primary_key", "test_primary_key")
    mocker.patch.object(DatosGovCoStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = DatosGovCoStream()
